        ...
        <div className="w-full gap-6 flex justify-evenly lg:justify-center lg:gap-14">
          <div className="relative duration-300 ease-in-out hover:scale-[1.2] cursor-pointer">
            <div className="firstText cursor-pointer">
              <div className="">
                <IoChatboxSharp className="absolute top-[20%] left-[20%] fill-[#bcd6ac] w-6 h-6" />
                <p className=" text-[8px] text-black font-bold absolute top-[21.5%] sm:left-[26%]">
                  1
                </p>
              </div>
              <p className="text1 absolute border bg-[#bcd6ac] text-black font-fira font-normal rounded-lg text-[8px] sm:text-[10px] mx-2 p-0.5 top-[15%] left-[33%]">
                Mobile responsive landing page
              </p>
            </div>

            <div className="secondText cursor-pointer">
              <IoChatboxSharp className="absolute  top-[40%] left-[30%] fill-[#bcd6ac] h-6 w-6" />

              <p className="absolute text-[8px] top-[41.5%] text-black font-bold sm:left-[36.5%]">
                2
              </p>
              <p className="text2 absolute border bg-[#bcd6ac] text-black font-fira font-normal rounded-lg text-[8px] sm:text-[10px] mx-2 p-0.5 top-[49%]">
            ...
            <div className="thirdText cursor-pointer">
              <div>
                <IoChatboxSharp className="absolute top-[82%] left-[48%] fill-[#bcd6ac] w-6 h-6" />
                <p className="absolute text-[8px] top-[84%] sm:left-[54%] text-black font-bold">
                  3
                </p>
              </div>
              <p className="text3 absolute border bg-[#bcd6ac] text-black font-fira font-normal rounded-lg text-[8px] sm:text-[10px] p-0.5 mx-2 top-[30%] sm:top-[54.5%]">
          ...
          <div className="relative duration-300 ease-in-out hover:scale-[1.2] cursor-pointer">
            <div className="fourthText cursor-pointer">
              <div>
                <IoChatboxSharp className="absolute top-[37%] left-[20%] fill-[#d08370] h-6 w-6" />
                <p className=" text-[8px] absolute top-[38%] sm:left-[25.5%] text-black font-bold">
                  4a
                </p>
              </div>

              <p className="text4 text-black absolute border bg-[#d08370] font-fira font-normal rounded-lg text-[8px] sm:text-[10px] p-0.5 sm:top-[9%] mx-2">
            ...
            <div className="fifthText cursor-pointer">
              <div>
                <IoChatboxSharp className="absolute top-[76%] left-[12%] fill-[#d08370] h-6 w-6" />
                <p className=" text-[8px] absolute top-[77.5%] left-[17%] text-black font-bold">
                  4b
                </p>
              </div>
              <p className="text5 absolute border bg-[#d08370] text-black font-fira font-normal rounded-lg mx-3 text-[8px] sm:text-[10px] p-0.5 top-[60%]">
            ...
            <div className="sixthText cursor-pointer">
              <div>
                <IoChatboxSharp className="absolute top-[75%] sm:top-[80%] left-[65%] fill-[#d08370] h-6 w-6" />
                <p className=" text-[8px] absolute sm:top-[81.5%] sm:left-[69.5%] text-black font-bold">
                  4c
                </p>
              </div>
              <p className="text6 absolute border bg-[#d08370] text-black font-fira font-normal rounded-lg text-[8px] sm:text-[10px] mx-3 p-0.5 top-[55%] sm:top-[66%]">
                So many pop ups not staggered is disruptive
              </p>
            </div>
          ...
          <div className="relative duration-300 ease-in-out hover:scale-[1.2] cursor-pointer">
            <div className="seventhText cursor-pointer">
              <div>
                <IoChatboxSharp
                  className="absolute sm:top-[50%]
                sm:left-[75%] fill-[#d08370] h-6 w-6"
                />
                <p className="text-[8px] text-black font-bold absolute sm:top-[51.5%] sm:left-[82%]">
                  5
                </p>
              </div>
              <p className="text7 absolute border bg-[#d08370] text-black font-fira font-normal rounded-lg text-[4px] sm:text-[10px] p-0.5 top-[20%] sm:top-[10%] mx-3">
            ...
            <div className="eighthText cursor-pointer">
              <div>
                <IoChatboxSharp
                  className="absolute sm:top-[82%]
                sm:left-[55%] fill-[#d08370] h-6 w-6"
                />
                <p className="text-[8px] absolute sm:top-[83.5%] sm:left-[62%] text-black font-bold">
                  6
                </p>
              </div>
          ...
          <div className="relative duration-300 ease-in-out hover:scale-[1.2] cursor-pointer">
            <div className="ninthText cursor-pointer">
              <div>
                <IoChatboxSharp className="absolute top-[65%] left-[70%] sm:top-[70%] fill-[#d08370] h-6 w-6" />
                <p className="text-[8px] absolute sm:top-[71.5%] sm:left-[76.5%] text-black font-bold">
                  7
                </p>
              </div>
