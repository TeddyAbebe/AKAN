...
import { analysisPageFive, analysisPageFiveNotes } from "../../../data/data";
    ...
    <div className="bg-black flex flex-col pt-24 sm:pt-10 text-white w-screen min-h-screen analysisPageFour">
      <div>
              ...
              <div className="flex">
                <div className="flex flex-col justify-center items-center gap-2.5 py-8">
                  ...
                  <img
                    src={val.funnel2}
                    alt=""
                    className="h-[70.59px] w-[208.33px] duration-500 ease-in-out hover:scale-[1.25] cursor-pointer"
                  />
                  <img
                    src={val.funnel3}
                    alt=""
                ...
                <div className="relative flex flex-col gap-16 pt-14">
                  ...
                  <div className="flex">
                    ...
                    />
                    <div className="flex  gap-2 font-fira font-bold text-xl ">
                      <p className="text-red-600">19%</p> proceed
                    </div>
                  </div>
        ...
        <div className="flex flex-col gap-3 mx-4 items-center">
          {analysisPageFiveNotes.map((val, i) => (
            <div className="">
              <img
